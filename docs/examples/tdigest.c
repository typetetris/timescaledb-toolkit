// cc -o tdigest tdigest.c $CARGO_TARGET_DIR/debug/libtimescaledb_toolkit_tdigest.a -lm -lpthread -ldl

// Sample program which prints the expected output of the test_tdigest_io test.

////////////////////////////////////////////////////////////////////////////////
// TODO Generate a header from tdigest-c crate.
...
main()
{
    ...
    printf("%s\n", timescaledb_toolkit_tdigest_format_for_postgres(td));
